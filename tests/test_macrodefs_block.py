...
def get_stil_file(file_name):
    ...
    return os.path.join(str(folder), "stil_files", "macrodefs_block", file_name)

def test_syn_ok_macrodefs_block_1():
    stil_file = get_stil_file("syn_ok_macrodefs_block_1.stil")
...
def test_syn_err_macrodefs_block_1():
    stil_file = get_stil_file("syn_err_macrodefs_block_1.stil")
...
def test_syn_err_macrodefs_block_2():
    stil_file = get_stil_file("syn_err_macrodefs_block_2.stil")
...
def test_syn_err_macrodefs_block_3():
    stil_file = get_stil_file("syn_err_macrodefs_block_3.stil")
...
def test_syn_err_macrodefs_block_4():
    stil_file = get_stil_file("syn_err_macrodefs_block_4.stil")
...
def test_syn_err_macrodefs_block_5():
    stil_file = get_stil_file("syn_err_macrodefs_block_5.stil")
